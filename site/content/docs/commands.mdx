...
In a terminal (and without `--plain`), this opens an interactive browser — **Skills** and **MCPs** tabs, each with a detail pane. Navigate with <kbd>j</kbd> / <kbd>k</kbd>, scroll with
<kbd>page-up</kbd> / <kbd>page-down</kbd>, jump with <kbd>g</kbd> <kbd>g</kbd> / <kbd>shift+g</kbd>. Switch tabs with <kbd>tab</kbd> or <kbd>h</kbd> / <kbd>l</kbd>.
